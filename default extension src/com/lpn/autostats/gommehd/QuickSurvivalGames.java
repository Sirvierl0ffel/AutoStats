...
/**
 * Manages the statistics of QuickSurvivalGames on gommehd.net
 * 
 * @author Sirvierl0ffel
 */

public class QuickSurvivalGames extends GommeHDExtension {

	private static final String HEAD = "\u00A7r\u00A7eGommeHD.net\u00A7r\u00A7e \u00A7r\u00A7aQuick SurvivalGames\u00A7r\n\u00A7r\u00A77Du m\u00F6chtest einen Spieler melden? \u00A7r\u00A7c/report \u00A7r\u00A77<Spieler>\u00A7r";

	/**
	 * Constructor to get invoked from {@link ExtensionManager#reloadExtensions()}
	 */
	public QuickSurvivalGames() {
