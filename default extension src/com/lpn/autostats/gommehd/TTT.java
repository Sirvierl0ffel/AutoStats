...
/**
 * Manages the statistics of TTT on gommehd.net
 * 
 * @author Sirvierl0ffel
 */

public class TTT extends GommeHDExtension {

	private static final String HEAD = "\u00A7r\u00A7eGommeHD.net\u00A7r\u00A7e \u00A7r\u00A7cTTT\u00A7r\n\u00A7r\u00A77Du m\u00F6chtest einen Spieler melden? \u00A7r\u00A7c/report \u00A7r\u00A77<Spieler>\u00A7r";

	private int kills, played;
	...
	protected Statistics createStatistics(String playerName) {
		...
		values.add(createValueFalsePositiveRate(7));
		...
		values.add(createValueRanking(1));
